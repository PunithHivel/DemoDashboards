...
from repositories.cursor_initial_sync_repository import (
...
router = APIRouter(prefix="/cursor-initial-sync", tags=["cursor-initial-sync"])
_repository = CursorInitialSyncRepository()

REQUIRED_FIELDS: Set[str] = {"organization_id"}
INT_FIELDS: Set[str] = {"organization_id", "user_integration_id"}
DATETIME_FIELDS: Set[str] = {"created_at", "updated_at", "from_date", "to_date"}


@router.post(
    "/csv",
    status_code=status.HTTP_201_CREATED,
    summary="Import cursor_initial_sync from CSV",
